...
print(
    "O número de qubits que possui o estado q1.qstate é igual ao número de qubits que possui o estado q2.qstate? ",
    end="",
)
...
print(
    "Número de qubits no estado q1.qstate é igual ao número de qubits no estado q2.qstate? Quantos? ",
    end="",
)
...
ns.qubits.operate(
    [a2, b1], ns.CNOT
)  # Aplicando CNOT em a2, b1: a2 = controle, b1 = alvo
separador(20)
...
print(
    "Número de qubits com estado compartilhado a2 antes do emaranhamento entre a2 e a1: ",
    end="",
)
...
print(
    "Número de qubits com estado compartilhado a2 após o emaranhamento entre a2 e a1: ",
    end="",
)
print(a2.qstate.num_qubits)
...
print(
    "Número de qubits com estado compartilhado a2 após as medições em a1 e a2: ", end=""
)
print(a2.qstate.num_qubits)
