...
procq = QuantumProcessor("ExemploQPU", num_positions=3, fallback_to_nonphysical=True)
...
instrucoes_fisicas = [
    ...
    PhysicalInstruction(
        instr.INSTR_CNOT, duration=4, parallel=True, topology=[(0, 1), (2, 1)]
    ),
...
procq_ruidoso = QuantumProcessor(
    "QPURuidosa",
    num_positions=3,
